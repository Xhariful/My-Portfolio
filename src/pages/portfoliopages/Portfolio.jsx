                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                        ...
                        <div class="portfolio-card bg-white rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-gray-600 mt-2">Created a responsive Visa prosessing and booking platform using
                                    HTML, Javascript, Bootstrap and Python django, featuring user
                                    registration and custom dashboard.</p>
                                <a href="https://european.bisswas.com/" target="_blank" class="text-blue-500 mt-3 inline-block">View Project</a>
                            </div>
                        </div>
                        ...
                        <div class="portfolio-card bg-white rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-gray-600 mt-2">Created a responsive grope and company website using HTML,
                                    Javascript, Tailwind CSS and Python django, featuring user
                                    registration and custom dashboard.</p>
                                <a href="https://www.rahmansonsgroup.com/profile" target="_blank" class="text-blue-500 mt-3 inline-block">View Project</a>
                            </div>
                        </div>
                        ...
                        <div class="portfolio-card bg-white rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-gray-600 mt-2">Created a responsive girl-hostel-Service web using HTML,
                                Javascript, Tailwind CSS, React and Node.js</p>
                                <a href="https://ronjona-hostel.vercel.app/" target="_blank" class="text-blue-500 mt-3 inline-block">View Project</a>
                            </div>
                        </div>
                        ...
                        <div class="portfolio-card bg-white rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105">
                            ...
                            <div class="p-4">
                                ...
                                <a href="#" target="_blank" class="text-blue-500 mt-3 inline-block">View Project</a>
                            </div>
                        </div>
